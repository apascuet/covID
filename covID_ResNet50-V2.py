# -*- coding: utf-8 -*-
"""
Created on Mon Jun 15 03:43:47 2020
...
model.fit(X_train, Y_train, validation_data = (X_test, Y_test), batch_size = 32, epochs = 2, callbacks = callbacks)
...
model.save_weights("ResNet50-V2_weights.h5")
